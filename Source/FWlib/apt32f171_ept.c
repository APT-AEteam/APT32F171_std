...
//EPT_CPCR_CMD:EPT_CPCR_ENALBE,EPT_CPCR_Disable，EPT_CPCR_CHAX_ENALBE|EPT_CPCR_CHAY_ENALBE|EPT_CPCR_CHBX_ENALBE|EPT_CPCR_CHBY_ENALBE|EPT_CPCR_CHCX_ENALBE|EPT_CPCR_CHCY_ENALBE
...
//BIT2->EPI2(0:Active high 1:Active low),BIT3->EPI3(0:Active high 1:Active low),BIT4->CMP0(0:Active high 1:Active low)        //cl
