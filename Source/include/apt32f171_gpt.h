...
#ifndef _apt32f171_gpt_H
#define _apt32f171_gpt_H
...
typedef enum
{
    GPT_CG_CHAX= (0<<11),    //WAVE = 1;
	GPT_CG_CHBX= (1<<11),
	
	EPT_CG_CHA= (0<<11),    //WAVE = 0;
	EPT_CG_CHB= (1<<11),
	EPT_CG_CHC= (2<<11),
	EPT_CG_CHD= (3<<11),
}GPT_CGSRC_TypeDef;
...
typedef enum		
{
	GPTA_PHSEN_DIS			=	((CSP_REGISTER_T)(0x00ul << 7)),
	GPTA_PHSEN_EN			=	((CSP_REGISTER_T)(0x01ul << 7))
}GPTA_PHSEN_CMD_Type;


typedef enum		
{
	GPTA_PHSDIR_increase			=	((CSP_REGISTER_T)(0x01ul << 31)),
	GPTA_PHSEN_decrease			=	((CSP_REGISTER_T)(0x00ul << 31))
}GPTA_PHSDIR_Type;
...
extern void GPT_PHSEN_Config(GPTA_PHSEN_CMD_Type GPT_PHSEN_CMD ,GPTA_PHSDIR_Type GPTA_PHSDIR , U16_T PHSR);
/*************************************************************/
