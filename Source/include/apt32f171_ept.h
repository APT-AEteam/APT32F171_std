...
#ifndef _apt32f171_ept_H
#define _apt32f171_ept_H
...
typedef enum		
{
	EPT_PHSEN_DIS			=	((CSP_REGISTER_T)(0x00ul << 7)),
	EPT_PHSEN_EN			=	((CSP_REGISTER_T)(0x01ul << 7))
}EPT_PHSEN_CMD_Type;
/**
...
typedef enum		
{
	EPT_CPCR_ENALBE		=	((CSP_REGISTER_T)(0x3ful<<16 )),  //all en
	EPT_CPCR_Disable	=	((CSP_REGISTER_T)(0x00ul<<16 )),
	EPT_CPCR_CHAX_ENALBE =  ((CSP_REGISTER_T)(0x01ul<<16 )),    //cl 以下选择时能使，调入时用或
	EPT_CPCR_CHAY_ENALBE =  ((CSP_REGISTER_T)(0x02ul<<16 )),
	EPT_CPCR_CHBX_ENALBE =  ((CSP_REGISTER_T)(0x04ul<<16 )),
	EPT_CPCR_CHBY_ENALBE =  ((CSP_REGISTER_T)(0x08ul<<16 )),
	EPT_CPCR_CHCX_ENALBE =  ((CSP_REGISTER_T)(0x10ul<<16 )),
	EPT_CPCR_CHCY_ENALBE =  ((CSP_REGISTER_T)(0x20ul<<16 )),
}EPT_CPCR_CMD_Type;
/**
...
typedef enum	
{
	...
	EPT_Input_selecte_CMP0			=		((CSP_REGISTER_T)(5)),         //cl
	EPT_Input_selecte_CMP1			=		((CSP_REGISTER_T)(6)),
	EPT_Input_selecte_CMP2			=		((CSP_REGISTER_T)(7)),
	EPT_Input_selecte_CMP3			=		((CSP_REGISTER_T)(8)),
	EPT_Input_selecte_CMP4			=		((CSP_REGISTER_T)(9)),
	EPT_Input_selecte_CMP5			=		((CSP_REGISTER_T)(0XA)),
	EPT_Input_selecte_LVD			=		((CSP_REGISTER_T)(0XB)),	
