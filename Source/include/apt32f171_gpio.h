...
#ifndef _apt32f171_gpio_H
#define _apt32f171_gpio_H
...
#define SetPA1(n)   (GPIOA1->SODR = (1ul<<n))
#define ClrPA1(n)   (GPIOA1->CODR = (1ul<<n))

#define SetPB0(n)   (GPIOB0->SODR = (1ul<<n))
#define ClrPB0(n)   (GPIOB0->CODR = (1ul<<n))

#define SetPC0(n)   (GPIOC0->SODR = (1ul<<n))
#define ClrPC0(n)   (GPIOC0->CODR = (1ul<<n))

#define PA0in(n)    (((GPIOA0->PSDR)>>n) & 1ul)
#define PA1in(n)    (((GPIOA1->PSDR)>>n) & 1ul)
#define PB0in(n)    (((GPIOB0->PSDR)>>n) & 1ul)
#define PC0in(n)    (((GPIOC0->PSDR)>>n) & 1ul)
...
************************** Exported functions ************************
******************************************************************************/
extern void GPIOA0_DeInit(GPIO_Pin_TypeDef GPIO_Pin);  //未定义？
...
extern void GPIO_Debug_IO_12_13(void);               //未定义？
extern void GPIO_Debug_IO_01_02(void);               //未定义？
extern void GPIO_IntGroup_Set(GPIO_Group_TypeDef IO_MODE , uint8_t PinNum , GPIO_EXIPIN_TypeDef EXIPIN_x);
extern void GPIOA00_Set_ResetPin();                  //未定义？
