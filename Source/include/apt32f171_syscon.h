...
#ifndef _apt32f171_syscon_H
#define _apt32f171_syscon_H
...
#define	SYSCON_DBGCR_RST		((CSP_REGISTER_T)0x0000005a)
...
typedef enum
{
	CLO_PA13		=	0,						//PA1.3 as clo
	CLO_PB03		=	1,						//PB0.3 as clo	
	CLO_PC01		=	2,						//PC0.1 as clo	
	CLO_PA08		=	3,						//PA0.8 as clo	
}CLO_IO_TypeDef;
