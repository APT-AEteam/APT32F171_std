...
#ifndef _apt32f171_uart_H
#define _apt32f171_uart_H
...
#define UART_FIFO_EN        (0x01ul << 11)   /**FIFO      **/
#define UART_TX_FIFO_INT    (0x01ul << 12)  /**< TX fifo int Enable/disable    */
#define UART_RX_FIFO_INT    (0x01ul << 13)  /**< RX fifo int Enable/disable    */
#define UART_FIFO_1_8_INT   (0x01ul<< 14)   /**FIFO 1/8 INT**/
#define UART_FIFO_1_4_INT   (0x02ul<< 14) 
#define UART_FIFO_1_2_INT   (0x04ul<< 14) 
...
#define UART_RX_STTTO     (0x01ul << 20)
#define UART_RX_TO_INT     (0x01ul << 21)  /**< RX TIME OUT INT   */
#define UART_RX_BRK_INT     (0x01ul << 22)  /**< RX BREAK INT    */
...
#define UART_RX_TO_S     (0x01ul << 9)  /**< RX TIME OUT INT   */
#define UART_RX_BRK_S     (0x01ul << 10)  /**< RX BREAK INT    */
...
/** Set RTOR register                                                      */
#define CSP_UART_SET_RTOR(uart, val)  ((uart)->RTOR = (val))
/** Get BRDIV register                                                      */
#define CSP_UART_GET_RTOR(uart)       ((uart)->RTOR)

/** Set BRDIV register                                                      */
#define CSP_UART_SET_TTGR(uart, val)  ((uart)->TTGR = (val))
/** Get BRDIV register                                                      */
#define CSP_UART_GET_TTGR(uart)       ((uart)->TTGR)

/** Set BRDIV register                                                      */
#define CSP_UART_SET_SRR(uart, val)  ((uart)->SRR = (val))
...
extern void UART_Timeout_Rx_CMD(CSP_UART_T *uart,FunctionalStatus NewState,U16_T TIMEOUT);
extern void UART_Tx_Break_CMD(CSP_UART_T *uart,FunctionalStatus NewState);
extern void UART_Tx_TTGR_TIME(CSP_UART_T *uart,U8_T TIME_GUARD);
extern void UART_Software_Reset(CSP_UART_T *uart);
extern void UART_FIFO_CMD(UART_FIFO_TypeDef FIFO1_X,FunctionalStatus newState);
